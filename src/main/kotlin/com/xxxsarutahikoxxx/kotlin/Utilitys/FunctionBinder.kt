...
class FunctionBinder0<RECEIVER, RET> : FunctionBinder<RECEIVER, RECEIVER.()->(RET)>, (RECEIVER)->(RET), InfoMap by InfoMapImpl() {
...
class FunctionBinder1<RECEIVER, ARG1, RET> : FunctionBinder<RECEIVER, RECEIVER.(ARG1)->(RET)>, (RECEIVER, ARG1)->(RET), InfoMap by InfoMapImpl() {
    override var name : String? by _info
...
class FunctionBinder2<RECEIVER, ARG1, ARG2, RET> : FunctionBinder<RECEIVER, RECEIVER.(ARG1, ARG2)->(RET)>, (RECEIVER, ARG1, ARG2)->(RET), InfoMap by InfoMapImpl() {
    override var name : String? by _info
...
class FunctionBinder3<RECEIVER, ARG1, ARG2, ARG3, RET> : FunctionBinder<RECEIVER, RECEIVER.(ARG1, ARG2, ARG3)->(RET)>, (RECEIVER, ARG1, ARG2, ARG3)->(RET), InfoMap by InfoMapImpl() {
    override var name : String? by _info
...
class FunctionBinder4<RECEIVER, ARG1, ARG2, ARG3, ARG4, RET> : FunctionBinder<RECEIVER, RECEIVER.(ARG1, ARG2, ARG3, ARG4)->(RET)>, (RECEIVER, ARG1, ARG2, ARG3, ARG4)->(RET), InfoMap by InfoMapImpl() {
    override var name : String? by _info
...
class FunctionBinder5<RECEIVER, ARG1, ARG2, ARG3, ARG4, ARG5, RET> : FunctionBinder<RECEIVER, RECEIVER.(ARG1, ARG2, ARG3, ARG4, ARG5)->(RET)>, (RECEIVER, ARG1, ARG2, ARG3, ARG4, ARG5)->(RET), InfoMap by InfoMapImpl() {
    override var name : String? by _info
